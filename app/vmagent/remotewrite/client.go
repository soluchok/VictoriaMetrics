...
var (
	...
	tlsHandshakeTimeout   = flagutil.NewDictValue("remoteWrite.tlsHandshakeTimeout", 20*time.Second, '/', "The timeout for estabilishing tls connections to the corresponding -remoteWrite.url")
